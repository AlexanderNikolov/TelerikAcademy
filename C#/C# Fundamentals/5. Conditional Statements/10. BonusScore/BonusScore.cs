namespace TAonline.CSharp.ConditionalStatements.Homework5
{
    ...
    /// multiplies it by 10; if it is between 4 and 6, multiplies it by 100;
    ...
    class Task10
    {
        static void Main()
        {
            ...
            {
                case 0:
                    Console.WriteLine("Error. Wrong value inputed!"); break;
                case 1:
                case 2:
                case 3:
                ...
                default:
                    Console.WriteLine("Error. Cat\'t recognize this digit!"); break;
            }
        }
    }
}